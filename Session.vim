...
argglobal
balt src/components/ProjContent.js
setlocal fdm=manual
setlocal fde=0
setlocal fmr={{{,}}}
setlocal fdi=#
...
wincmd w
argglobal
if bufexists("src/content/projects.js") | buffer src/content/projects.js | else | edit src/content/projects.js | endif
if &buftype ==# 'terminal'
...
silent! normal! zE
let &fdl = &fdl
let s:l = 26 - ((10 * winheight(0) + 22) / 44)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 26
...
badd +18 src/content/projects.js
